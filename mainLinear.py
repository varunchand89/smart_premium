...
if submitted:
    ...
    mlflow.set_experiment("Linear_Regression_Automation_11")
    ...
    with mlflow.start_run(run_name="Minmax"):
        ...
        LinearRegression_1.fit(A_train,b_train)

        B_pred = LinearRegression_1.predict(A_test)
        signature = infer_signature(A_train, LinearRegression_1.predict(A_train))
    ...
    # Get the MLflow client
        ...
        predicted_values = LinearRegression_1.predict(cato_test_1)
