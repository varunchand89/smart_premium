...
with mlflow.start_run(run_name="MinmaxX"):
        ...
        #3cato_train_38 = scaler(cato_train_1,categorical_columns_cato_train_2)
        #cato_train_3 = cato_train_38.scaler_z()

        cato_train_3 = cato_train_1
