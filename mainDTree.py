...
if submitted:
    ...
    mlflow.set_experiment("Decision_tree_Regressor_89")
    ...
    with mlflow.start_run(run_name="Minmax"):
        ...
        Decision_tree = DecisionTreeRegressor(max_depth=4, min_samples_leaf=5)
        Decision_tree.fit(A_train,b_train)

        B_pred = Decision_tree.predict(A_test)
        signature = infer_signature(A_train, Decision_tree.predict(A_train))
    ...
    # Get the MLflow client
        ...
        predicted_values = Decision_tree.predict(cato_test_1)
